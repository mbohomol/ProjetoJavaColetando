...
public class SistemaColeta {
	...
	ArrayList<String> grupo1  = new ArrayList<>();
		...
		if (grupo1.contains(rua)) {
			 ...
			 System.out.println("A sua rua faz parte do Grupo 2 e a coleta ocorre ás terças as e sextas-feiras.");
			 System.out.println("Seu grupo também possui um ponto de coleta fixa, na rua Pompeia, nº 171, com funcionamento de segunda a sexta das 8:00 hrs às 17:00 hrs");
			 controler = false;
		}
