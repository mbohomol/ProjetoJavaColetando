    ...
    public void QuizColetando()
    {
		...
		while (controle) {
         ...
         while(controle) {
			...
			System.out.println("[1] ELA AJUDA CADA VEZ MAIS AO DESMATAMENTO DA FLORESTA AMAZAÔNICA.");
			System.out.println("[2] A COLETA SELTIVA NÃO SERVE PARA NADA.");
          ...
          while(controle) {
    		...
    		case "3": 
               ...
               System.out.println("VOCÊ TOTALIZOU:" + total + " PONTOS (;"); 
     		   ...
     		   if (total == 120)
     		   {
     			   System.out.println("Parabéns!! Você acaba de receber 85% de desconto na sua próxxima conta de luz!");
     			  this.opcao = 2;
     		   }
     		   else if(total == 100 || total == 80)
     		   {
     			  System.out.println("Parabéns!! Você acaba de receber 85% de desconto na sua próxima conta de água!");
     			 this.opcao = 2;
     		   }
     		   else if(total == 60 || total == 40)
     		   {
     			   System.out.println("Parabéns!! Você acaba de receber 70% de desconto na sua próxima compra de gás!!");
     			  this.opcao = 2;
     		   }
     		   else if (total <= 20)
     		   {
